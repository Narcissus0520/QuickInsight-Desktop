...
- Published the verified `v0.0.0` GitHub Release with the Windows x64 installer, portable ZIP, SHA-256 sums, third-party license inventory, release notes, and package report.
